...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-cream">
      ...
      <div className="absolute inset-0 border-4 md:border-8 border-gold/30 pointer-events-none" />
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20 text-center">
        ...
        <div className="mb-2 md:mb-4 opacity-0 animate-slideUpFade" style={{ animationDelay: '1.5s' }}>
          <p className="font-display text-2xl sm:text-3xl md:text-5xl lg:text-6xl text-gold font-semibold tracking-wider">
            Band Baja
          </p>
        </div>
        
        {/* Odyssey Title - appears after Band Baja */}
        <div className="mb-4 md:mb-8 opacity-0 animate-slideUpFade" style={{ animationDelay: '1.8s' }}>
          <h1 className="font-display text-5xl sm:text-7xl md:text-9xl lg:text-[12rem] font-bold text-primary tracking-wider drop-shadow-[0_4px_12px_rgba(0,0,0,0.3)]">
            Odyssey
          </h1>
        </div>
        ...
        <div className="opacity-0 animate-slideUpFade" style={{ animationDelay: '2.1s' }}>
          <p className="font-body text-base sm:text-xl md:text-2xl text-primary/80 max-w-2xl mx-auto px-4">
